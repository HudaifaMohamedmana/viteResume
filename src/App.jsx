      ...
      <div className="introduction">
        <div className="IntElement" id="ProfessionalSummary">
          ...
          <p>
            * Outstanding research and information management capabilities.
            <br />
            * Proven ability to work collaboratively with diverse groups and
            establish ongoing relationships.
            <br />
            * Capable of quickly understanding how systems are used in order to
            provide efficient support.
            <br />
            * Demonstrated outstanding customer orientation using strong
            communication skills.
            <br />* Strong leadership and problem-solving.
          </p>
        </div>
        ...
        <div className="IntElement" id="TechnicalSkills">
          ...
          <p>
            * Business management.
            <br />
            * Experience with many computer languages like HTML, CSS,
            JavaScript, Java, C, and C++.
            <br />
            * Fluent in Arabic and English. (translator certificate)
            <br />* SQL and data structure.
          </p>
        </div>
      </div>
